---
title: "Extend Built-in Data Types"
...
```tsx
import { JsonViewer, defineDataType, booleanType } from '@helt/mui-json-viewer'
...
/>
```
[[Source Code]](https://github.com/helt/mui-json-viewer/blob/main/docs/src/examples/JsonViewerToggleBoolean.tsx)
...
```tsx
import { defineEasyType, booleanType } from '@helt/mui-json-viewer'
