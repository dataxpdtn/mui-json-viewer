...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tabs.Tab label="npm">``` npm install @dataxpdtn/mui-json-viewer @mui/material @emotion/react @emotion/styled ```</Tabs.Tab>
  <Tabs.Tab label="yarn">``` yarn add @dataxpdtn/mui-json-viewer @mui/material @emotion/react @emotion/styled ```</Tabs.Tab>
  <Tabs.Tab label="pnpm">``` pnpm add @dataxpdtn/mui-json-viewer @mui/material @emotion/react @emotion/styled ```</Tabs.Tab>
</Tabs>
...
<br />
<Button variant="contained"  href="/full" target="_blank">
  DEMO
</Button> 

Check the [source code](https://github.com/dataxpdtn/mui-json-viewer/blob/main/docs/pages/full/index.tsx) for more details.
...
<a href="https://github.com/dataxpdtn/mui-json-viewer/graphs/contributors">
